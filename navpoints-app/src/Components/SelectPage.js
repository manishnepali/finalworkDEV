    ...
    return (
        <div className="SelectPage">
            ...
            <div className='bg-backimg h-screen md:flex overflow-hidden'>
                ...
                <Link to="/">
                <svg class="w-16 h-16 mx-8 mt-8  dark:text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 15l-3-3m0 0l3-3m-3 3h8M3 12a9 9 0 1118 0 9 9 0 01-18 0z"></path></svg>
                   </Link>
                     ...
                     options={options}/> */}
                      ...
                      {data.map((category, index)=>{
                        return <li className="p-4">
                          ...
                          <label 
                          className="text-4xl text-black font-bold my-4 ml-4"
